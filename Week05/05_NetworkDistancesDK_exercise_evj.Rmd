...
outside_driving20 <- st_difference(st_geometry(driving_isos, Midtjylland))

#isochromes: object <- st_area(Midt)-st_area(st_union(iso_driving20)) -->gives area i km2
st_area(Midtjylland)-st_area(st_union(outside_driving20))

class(Midtjylland)
class(outside_driving20)


#st_difference(Midt, object)
st_difference(Midtjylland, iso)
```
