...
Research question: How much ground is covered with the rose fields today?
...
# Inspect the train object
head(train)
plot(train)

# load in file which are already merged and aggregated (and cropped?)


# Generate NDVI and NDIV0 => new brick
...
plot(ndvi)
plot(train["Class"], add = TRUE, pal = cols)
...
Adela wrote on the board:

1) merge raster --> raster:merge()
2) crop the result with e <- draw(xtent(show = T, col = "red))
